...
DEFAULT_FOOTBALL_DATA_SERIE_A_FIXTURES_URL = DEFAULT_FOOTBALL_DATA_SERIE_A_URL
...
FOOTBALL_DATA_SERIE_A_FIXTURES_URL = (
    os.getenv("FOOTBALL_DATA_SERIE_A_FIXTURES_URL", DEFAULT_FOOTBALL_DATA_SERIE_A_FIXTURES_URL).strip()
    or DEFAULT_FOOTBALL_DATA_SERIE_A_FIXTURES_URL
)
CLUBELO_RATINGS_URL = (
...
FIXTURE_SEED_PATH = RAW_DATA_DIR / "serie_a_fixtures_seed.csv"
